...
VALUES (1, 1, 1, '커핏 강남점', '강남역 5분 거리의 스페셜티 커피 전문점입니다. 다양한 원두와 핸드드립 커피를 제공합니다.',
       ...
       (2, 2, 1, '블루보틀 강남점', '블루보틀의 시그니처 메뉴를 만나보세요.', '서울특별시 강남구 테헤란로 152', 37.49950000,
...
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (3, 3, 1, '프릳츠 홍대점', '홍대의 감성을 담은 카페입니다. 시그니처 라떼가 인기 메뉴입니다.', '서울특별시 마포구 와우산로29길 8',
        37.55630000, 126.92340000, '02-3456-7890', '라떼', 'https://example.com/stores/hongdae1.jpg', '09:00:00',
        '23:00:00', 4.30, 98, 412, false),
       (4, 1, 1, '커핏 홍대점', '젊은 감성의 커피 문화를 선도합니다.', '서울특별시 마포구 양화로 160', 37.55800000, 126.92100000,
...
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (5, 4, 1, '앤트러사이트 성수점', '성수동의 핫플레이스! 넓은 공간과 좋은 커피', '서울특별시 성동구 연무장길 7', 37.54460000,
        127.05570000, '02-5678-9012', '아메리카노', 'https://example.com/stores/seongsu1.jpg', '08:00:00', '21:00:00', 4.60,
        189, 734, false),
       (6, 3, 1, '프릳츠 성수점', '성수동 카페거리의 대표 매장', '서울특별시 성동구 아차산로 17길 49', 37.54520000, 127.05680000,
...
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (7, 5, 1, '테라로사 종로점', '전통과 현대가 만나는 스페셜티 커피', '서울특별시 종로구 삼일대로 428', 37.57010000, 126.99110000,
...
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (8, 2, 1, '블루보틀 이태원점', '이태원의 글로벌한 분위기 속 프리미엄 커피', '서울특별시 용산구 이태원로 223', 37.53470000,
        126.99460000, '02-8901-2345', '플랫화이트', 'https://example.com/stores/itaewon1.jpg', '08:00:00', '20:00:00', 4.75,
        267, 1023, false),
       (9, 1, 1, '커핏 이태원점', '다국적 문화가 어우러진 특별한 커피 공간', '서울특별시 용산구 녹사평대로 164', 37.53350000,
...
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (10, 4, 1, '앤트러사이트 신촌점', '대학가 감성의 넓고 쾌적한 카페', '서울특별시 서대문구 신촌로 83', 37.55590000, 126.93680000,
        '02-0123-4567', '라떼', 'https://example.com/stores/sinchon1.jpg', '08:00:00', '23:00:00', 4.35, 178, 692, false);

-- 7. 잠실
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (11, 5, 1, '테라로사 잠실점', '롯데월드타워 근처 프리미엄 커피 전문점', '서울특별시 송파구 올림픽로 300', 37.51330000,
...
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (12, 3, 1, '프릳츠 명동점', '명동 쇼핑의 피로를 풀 수 있는 힐링 카페', '서울특별시 중구 명동길 74', 37.56360000,
...
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (13, 2, 1, '블루보틀 여의도점', '직장인들의 휴식처, IFC몰 근처', '서울특별시 영등포구 여의대로 108', 37.52190000,
        126.92450000, '02-3456-0987', '핸드드립', 'https://example.com/stores/yeouido1.jpg', '07:00:00', '20:00:00', 4.65,
        298, 1234, false),
       (14, 1, 1, '커핏 여의도점', '바쁜 업무 중 찾는 프리미엄 커피', '서울특별시 영등포구 의사당대로 83', 37.52340000, 126.92560000,
...
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (15, 4, 1, '앤트러사이트 건대점', '젊음의 거리 건대에서 만나는 감성 카페', '서울특별시 광진구 아차산로 243', 37.54030000,
...
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (16, 6, 1, '모모스커피 압구정점', '압구정 로데오거리의 감성 카페', '서울특별시 강남구 압구정로 152', 37.52740000,
        127.02860000, '02-6789-1234', '라떼', 'https://example.com/stores/apgujeong1.jpg', '10:00:00', '22:00:00', 4.55,
        198, 756, false),
       (17, 5, 1, '테라로사 압구정점', '세련된 공간에서 즐기는 스페셜티 커피', '서울특별시 강남구 논현로 825', 37.52650000,
...
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (18, 7, 1, '카페 온즈 망원점', '망원 한강공원 근처 힐링 카페', '서울특별시 마포구 포은로 100', 37.55570000, 126.90440000,
        '02-8901-3456', '디저트', 'https://example.com/stores/mangwon1.jpg', '11:00:00', '23:00:00', 4.15, 89, 345, false);

-- 13. 연남동
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (19, 3, 1, '프릳츠 연남점', '연남동 골목길의 숨은 보석', '서울특별시 마포구 동교로 200', 37.56370000, 126.92460000,
...
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (20, 2, 1, '블루보틀 코엑스점', '코엑스몰 내 대형 매장', '서울특별시 강남구 영동대로 513', 37.50880000, 127.06320000,
...
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (21, 4, 1, '앤트러사이트 서촌점', '한옥 카페의 정취를 느낄 수 있는 곳', '서울특별시 종로구 자하문로 10길 18', 37.58140000,
...
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (22, 6, 1, '모모스커피 한남점', '한남동의 세련된 감성 카페', '서울특별시 용산구 이태원로 273', 37.53400000, 127.00260000,
        '02-2345-7890', '라떼', 'https://example.com/stores/hannam1.jpg', '09:00:00', '21:00:00', 4.65, 201, 798, false);

-- 17. 광화문
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (23, 1, 1, '커핏 광화문점', '광화문 사거리 근처 직장인 카페', '서울특별시 종로구 세종대로 172', 37.57200000,
...
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (24, 7, 1, '카페 온즈 용산점', '용산역 근처 편안한 카페', '서울특별시 용산구 한강대로 95', 37.53110000, 126.98100000,
...
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (25, 5, 1, '테라로사 상수점', '상수동 감성 카페거리의 보석', '서울특별시 마포구 와우산로 29', 37.54780000, 126.92270000,
...
INSERT INTO stores (id, roastery_id, owner_id, name, description, address, latitude, longitude, phone_number, category,
                    thumbnail_url, open_time, close_time, average_rating, review_count, visit_count, is_closed)
VALUES (26, 3, 1, '프릳츠 을지로점', '을지로 힙스터들의 아지트', '서울특별시 중구 을지로 166', 37.56640000, 126.99100000,
