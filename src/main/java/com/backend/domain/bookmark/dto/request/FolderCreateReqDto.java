...
@Schema(description = "북마크 폴더 생성 요청 DTO")
public record FolderCreateReqDto(
	@Schema(description = "폴더 아이콘명", example = "coffee", defaultValue = "bookmark-fill")
