...
public record CuppingNoteReqDto(
	...
	@DecimalMax(value = "10.00", message = "Fragrance 점수는 10.00 이하여야 합니다.")
	BigDecimal fragranceScore,

	@Schema(description = "Aroma 점수 (0.00 ~ 10.00)", example = "8.00", requiredMode = RequiredMode.REQUIRED)
	@NotNull(message = "Aroma 점수는 필수 입력값입니다.")
	@DecimalMin(value = "0.00", message = "Aroma 점수는 0.00 이상이어야 합니다.")
	@DecimalMax(value = "10.00", message = "Aroma 점수는 10.00 이하여야 합니다.")
	BigDecimal aromaScore,

	@Schema(description = "Flavor 점수 (0.00 ~ 10.00)", example = "9.00", requiredMode = RequiredMode.REQUIRED)
	@NotNull(message = "Flavor 점수는 필수 입력값입니다.")
	@DecimalMin(value = "0.00", message = "Flavor 점수는 0.00 이상이어야 합니다.")
	@DecimalMax(value = "10.00", message = "Flavor 점수는 10.00 이하여야 합니다.")
	BigDecimal flavorScore,

	@Schema(description = "Aftertaste 점수 (0.00 ~ 10.00)", example = "8.75", requiredMode = RequiredMode.REQUIRED)
	@NotNull(message = "Aftertaste 점수는 필수 입력값입니다.")
	@DecimalMin(value = "0.00", message = "Aftertaste 점수는 0.00 이상이어야 합니다.")
	@DecimalMax(value = "10.00", message = "Aftertaste 점수는 10.00 이하여야 합니다.")
	BigDecimal aftertasteScore,

	@Schema(description = "Acidity 점수 (0.00 ~ 10.00)", example = "8.25", requiredMode = RequiredMode.REQUIRED)
	@NotNull(message = "Acidity 점수는 필수 입력값입니다.")
	@DecimalMin(value = "0.00", message = "Acidity 점수는 0.00 이상이어야 합니다.")
	@DecimalMax(value = "10.00", message = "Acidity 점수는 10.00 이하여야 합니다.")
	BigDecimal acidityScore,

	@Schema(description = "Sweetness 점수 (0.00 ~ 10.00)", example = "9.25", requiredMode = RequiredMode.REQUIRED)
	@NotNull(message = "Sweetness 점수는 필수 입력값입니다.")
	@DecimalMin(value = "0.00", message = "Sweetness 점수는 0.00 이상이어야 합니다.")
	@DecimalMax(value = "10.00", message = "Sweetness 점수는 10.00 이하여야 합니다.")
	BigDecimal sweetnessScore,

	@Schema(description = "Mouthfeel 점수 (0.00 ~ 10.00)", example = "8.50", requiredMode = RequiredMode.REQUIRED)
	@NotNull(message = "Mouthfeel 점수는 필수 입력값입니다.")
	@DecimalMin(value = "0.00", message = "Mouthfeel 점수는 0.00 이상이어야 합니다.")
	@DecimalMax(value = "10.00", message = "Mouthfeel 점수는 10.00 이하여야 합니다.")
